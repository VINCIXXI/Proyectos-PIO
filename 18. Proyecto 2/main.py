...
def agregar_libro(titulo, autor, isbn, genero, cantidad):
    libros.append({
        "titulo": titulo,
        "autor": autor,
        "isbn": isbn,
...
#Funsion para mostrar todos los usuario
def mostrar_usuario():
    if usuarios: #si hay usuarios o usuario existe
...
#next almacena el valor en la variable y avanza al siguiente valor
